            ...
            if (highestGradeStudents.size() < amount){
                ...
                for (int i = 0; i < highestGradeStudents.size(); i++) {
                    ...
                    if (average < minAverage){
                        minAverage = average;
                        minIndex = i; //This is the index in the array that the student with the lower average is at.
                    }
                }
                if (currentAverage > minAverage){ //Checks if the current student has an average that is higher than the lowest average among the best students
                    highestGradeStudents.set(minIndex, student); //Replacing the student with the lowest average with the current student (currentAverage)
                }
            }
        }
